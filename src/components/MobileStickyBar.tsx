...
const WA_MESSAGE = "Hola! Busco hospedaje en Guadalajara [desde mobile]";
    ...
    >
      <div className="flex items-center justify-between gap-2 px-4 py-3">
        <div className="shrink-0">
          ...
          <p className="text-sm font-bold text-foreground leading-tight"><span style={{ fontSize: 16, fontWeight: 800 }}>$1,900</span>/noche</p>
        </div>
        <a
          href={PHONE_NUMBER}
          className="flex items-center justify-center w-12 h-12 rounded-full border border-border bg-background text-foreground shrink-0"
