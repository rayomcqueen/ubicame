...
const FloatingButtons = () => {
  return (
    <>
      ...
      <a
        href={PHONE_NUMBER}
        className="floating-btn bottom-6 right-[10.5rem] w-14 h-14 bg-primary text-primary-foreground flex items-center justify-center"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        onClick={(e) => trackAndOpenWhatsApp(e, buildWhatsAppUrl(WA_MESSAGE), "floating")}
